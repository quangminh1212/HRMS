...
def set_header_footer(ws, title: str | None = None, username: str | None = None) -> None:
    """Set a simple header/footer: centered title, left footer generated by HRMS (+username), right footer timestamp + page numbers."""
    try:
        t = title or ws.title or "Report"
